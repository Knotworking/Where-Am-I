...
public class FlickrResponseJsonAdapter(
  ...
  private val photosResponseAdapter: JsonAdapter<PhotosResponse> =
      moshi.adapter(PhotosResponse::class.java, emptySet(), "photos")
  ...
  public override fun fromJson(reader: JsonReader): FlickrResponse {
    ...
    while (reader.hasNext()) {
      when (reader.selectName(options)) {
        0 -> photos = photosResponseAdapter.fromJson(reader) ?: throw Util.unexpectedNull("photos",
            "photos", reader)
        -1 -> {
  ...
  public override fun toJson(writer: JsonWriter, value_: FlickrResponse?): Unit {
    ...
    writer.beginObject()
    writer.name("photos")
    photosResponseAdapter.toJson(writer, value_.photos)
    writer.endObject()
  }
}
